define([], function() {
    ...
    **/
    PresentationController_Tablet.prototype.navigateToStoreForm = function(data) {
    ...
    */
    PresentationController_Tablet.prototype.fetchAppsList = function() {
        voltmx.application.dismissLoadingScreen();
    ...
    */
    PresentationController_Tablet.prototype.fetchAppsListSuccessCallback = function(data) {
    ...
    */
    PresentationController_Tablet.prototype.updateStoreForm = function(data) {
    ...
    */
    PresentationController_Tablet.prototype.fetchAppsListErrorCallback = function(error) {
    ...
    */
    PresentationController_Tablet.prototype.fetchAppDetails = function() {
        voltmx.application.dismissLoadingScreen();
   ...
   */   
    PresentationController_Tablet.prototype.fetchAppDetailsSuccessCallback = function(data) {
        currentScope.index = 0;
        var filteredData = [];
        currentScope.appsCount = 0;
        if(data && data.length >0){
   ...
   */
    PresentationController_Tablet.prototype.updateDetailsForm = function(data) {
   ...
   */
    PresentationController_Tablet.prototype.fetchAppDetailsErrorCallback = function(error) {
      	refreshAppFlag = false;
        var response = {
            "data": error,
            "isError": true
    ...
    */
    PresentationController_Tablet.prototype.startDownloadProcess = function(selectedRowItem) {
        voltmx.application.dismissLoadingScreen();
   ...
   */
   PresentationController_Tablet.prototype.downloadSuccessCallback = function(res) {
   ...
   */
    PresentationController_Tablet.prototype.downloadErrorCallback = function(error) {
        var curFormId = voltmx.application.getCurrentForm().id;
        var response = {
            "data": error,
            "isError": false,
   ...
   */    
    PresentationController_Tablet.prototype.getAppIconforAllApps = function(formId) {
        ...
        currentScope.temp.appDescription = metaData[index].System_ChannelAppDescription;
      	...
      	if(systemChannelId === config.responsive_web_channel_id || systemChannelId === config.native_web_channel_id){
          	...
          	currentScope.temp.btnLaunch = {"text":"OPEN","isVisible":false};
