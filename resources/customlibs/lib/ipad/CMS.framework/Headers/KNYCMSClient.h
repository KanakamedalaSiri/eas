...
//  Metrics
//
//  Copyright (c) 2021 HCL America, Inc. All rights reserved.
//
...
/**
 ...
 @"baseId":@"testbaseId",
 @"reportingsvc": @{
 @"custom": @"https://nut007.hclvoltmx.net/services/CMS",
 @"session": @"https://nut007.hclvoltmx.net/services/IST"
 } };
...
/**
 Authenticates you with the HCL Volt MX Mobile Foundry Service. The appKey, appSecret and serviceURLString are available in the HCL Mobile Foundry Console.
...
/**
 set client params (used for Iris apps using MF backend)
